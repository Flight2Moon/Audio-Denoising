...
dataset = DenoisingAudioDataset(
        input_dir= f'/home/jihoney/workdir/main_workdir/audio_denoising/dataset/unziped/development_dataset/{machine_class[0]}/train', 
        target_dir=f'/home/jihoney/workdir/main_workdir/audio_denoising/dataset/dcase_denoised_dataset/{machine_class[0]}/train_wav',
        sr=16000, 
        max_length=64000
    )
...
for epoch in range(epochs):
    ...
    torch.save(model.state_dict(), f'diffwave_finetune_epoch{epoch+1}.pth')