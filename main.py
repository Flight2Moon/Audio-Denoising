...
def get_device():
    ...
    if torch.backends.mps.is_available():
        ...
        device = torch.device(f"cuda:{gpu_number_setting}")
        # cuda:0 --> screen gpu_0
        # cuda:1 --> screen gpu_1
...
def main():
    ...
    ################################################
    for index in range(index_start_point, index_end_point):
    ...
    #/home/jihoney/workdir/main_workdir/audio_denoising/dataset/dcase2023_task2_dataset/unzip/dev_data/bearing
        ...
        if torch.cuda.device_count() == 1 or "RANK" not in os.environ:
            ...
            model = model.to(f"cuda:{gpu_number_setting}")
