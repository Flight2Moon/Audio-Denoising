...
def main():
    ...
    experiments_name = 'dcase_reshaped'
    ...
    # /home/jihoney/workdir/main_workdir/audio_denoising/dataset/unziped/development_dataset
        dataset_root_path = f'/home/jihoney/workdir/main_workdir/audio_denoising/dataset/unziped/development_dataset/{selected_machine}'
        ...
        torch.save(model.state_dict(), os.path.join(model_save_path, f'{experiments_name}_{batch_size}b_{epochs}e_{selected_machine}_{max_pairs_per_audio}pairs_{input_size}x{input_size}.pt'))
